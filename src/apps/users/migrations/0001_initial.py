    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(blank=True, help_text="Уникальный email пользователя.", max_length=254, null=True, unique=True, verbose_name="Email"),
                ),
                ("phone", models.CharField(blank=True, help_text="Контактный телефон пользователя.", max_length=32, verbose_name="Телефон")),
